...
from gps_interfaces.msg import Customrtk    #Cutom interface
from std_msgs.msg import String
from .decoders import GNGGAPositionData as PositionData
...
class GPSPublisher(Node):
    def __init__(self, port_address=DEFAULT_PORT):
        ...
        self.__publisher = self.create_publisher(Customrtk,self.__pub_topic,MAX_MSG)
...
#------------------------------------------
    ...
    def publish_message(self, message:PositionData):
        ...
        msg.fix_quality = message.get_fix_quality()
        msg.gngga_read = message.get_read_string()
